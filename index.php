   ...
   <body>
					 ...
					 <ul class="list-unstyled messages-list">
							...
							if(mysqli_num_rows($res)>0){
								...
								<li class="messages-me clearfix start_chat">
								   Start with hii,hello or namasthe
								</li>
								<?php
							}
							?>
      ...
      <script type="text/javascript">
		 ...
		 function send_msg(){
			...
			var html='<li class="messages-me clearfix"><span class="message-img"><img src="images/user.png" class="avatar-sm rounded-circle"></span><div class="message-body clearfix"><div class="message-header"><strong class="messages-title">Me</strong> <small class="time-messages text-muted"><span class="fas fa-time"></span> <span class="minutes">'+getCurrentTime()+'</span></small> </div><p class="messages-p">'+txt+'</p></div></li>';
